...
* ¹¦    ÄÜ £º5Â· ²¶»ñÅäÖÃ 
						TIM5 CH1~CH4¶ÔÓ¦Òý½Å£ºPA0,PA1,PA2,PA3
...
* ÅäÖÃ£º1# US100 ECHO£ºPA0£¬  TRIG:PG3
				2# US100 ECHO£ºPA2£¬  TRIG:PG4
				3# US100 ECHO£ºPB3£¬  TRIG:PG5
				4# US100 ECHO£ºPB10£¬ TRIG:PD11
				5# US100 ECHO£ºPB11£¬ TRIG:PD12
...
//	TIM_ICInit(TIM2, &TIM2_ICInitStructure);
	...
	TIM_ICInit(TIM2, &TIM2_ICInitStructure);
	// ÔÊÐí²¶»ñÖÐ¶Ï ÓÃµ½µÄÍ¨µÀÔÊÐíÖÐ¶Ï
		TIM_ITConfig(TIM5, TIM_IT_CC1  | TIM_IT_CC3   |TIM_IT_Update,ENABLE);//ÔÊÐí¸üÐÂÖÐ¶Ï ,ÔÊÐíCC1IE²¶»ñÖÐ¶Ï	
...
//				printf(" tch->CAPTURE_STA = %d ",tch->CAPTURE_STA); //´òÓ¡×ÜµÄ¸ßµãÆ½Ê±¼ä
				...
				{
					case TIM_IT_CC1:
						TIM_OC1PolarityConfig(tch->timX,TIM_ICPolarity_Falling); //CC1P=0 ÉèÖÃÎªÏÂ½µÑØ²¶»ñ
						break;
					case TIM_IT_CC2:
						TIM_OC2PolarityConfig(tch->timX,TIM_ICPolarity_Falling); //CC1P=0 ÉèÖÃÎªÏÂ½µÑØ²¶»ñ
						break;
					case TIM_IT_CC3:
						TIM_OC3PolarityConfig(tch->timX,TIM_ICPolarity_Falling); //CC1P=0 ÉèÖÃÎªÏÂ½µÑØ²¶»ñ
						break;
					case TIM_IT_CC4:
						TIM_OC4PolarityConfig(tch->timX,TIM_ICPolarity_Falling); //CC1P=0 ÉèÖÃÎªÏÂ½µÑØ²¶»ñ
						break;
					default:
						break;
				}
